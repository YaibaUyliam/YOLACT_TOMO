...
dataset_base = Config({
    ...
    #Option for KLA Format
    "class_label_dictionary": None
})


TOMO_CLASSES = ("bottle_cap", "bottle_uncap", "fallen_bottle", "flip_bottle")

TOMO_LABEL_MAP ={1: 1, 2: 2, 3: 3, 4: 4}


tomo_dataset = dataset_base.copy({
        "name":"Tomo Dataset",

        "train_images": "/home/jay2/TOMO/Dataset/Data_bottle/Data_train_bottle_2022_06_08/train",
        "train_info":   "/home/jay2/TOMO/Dataset/Data_bottle/Data_train_bottle_2022_06_08/train.json",

        "valid_images": "/home/jay2/TOMO/Dataset/Data_bottle/Data_train_bottle_2022_06_08/val",
        "valid_info":   "/home/jay2/TOMO/Dataset/Data_bottle/Data_train_bottle_2022_06_08/val.json",

        "class_names": TOMO_CLASSES,
        "label_map": TOMO_LABEL_MAP
})
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': tomo_dataset,
    'num_classes': len(tomo_dataset.class_names) + 1,
    ...
    'lr_steps': (29000, 38000, 50000, 70000),
    'max_iter': 100000,
    'epochs': 300,
    ...
    'mask_alpha': 6.125,    #'mask_alpha': 6.125,
    'mask_proto_src': 0,
    'mask_proto_net': [(256, 3, {'padding': 1})] * 3 + [(None, -2, {}), (256, 3, {'padding': 1})] + [(32, 1, {})],
    #'mask_proto_net': [(128, 3, {'padding': 1})] * 3 + [(None, -2, {}), (128, 3, {'padding': 1})] + [(16, 1, {})],
    'mask_proto_normalize_emulate_roi_pooling': True,

    # Other stuff
    'share_prediction_module': True,
    'extra_head_net': [(256, 3, {'padding': 1})],
    #'extra_head_net': [(128, 3, {'padding': 1})],
    'positive_iou_threshold': 0.8,
    # 'negative_iou_threshold': 0.4,
    'negative_iou_threshold': 0.8,
...
# Default config
cfg_1 = yolact_edge_config.copy()
#cfg = LoadJSON_config("/home/finn/yolact_edge/yolact_edge/config.json")._load_config()

# cfg.update({
#     'pred_scales': [[9], [18], [36], [72], [144]]
#     })

#cfg.backbone.pred_scales = [[9], [18], [36], [72], [144]]
