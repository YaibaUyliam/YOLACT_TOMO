...
class COCOAnnotationTransform(object):
    ...
    def __init__(self, cfg=None):
        if cfg is not None:
            self.label_map = get_label_map(cfg=cfg)
...
class COCODetection(data.Dataset):
    ...
    def __init__(self, image_path, info_file, transform=None,
                 target_transform=COCOAnnotationTransform(cfg=None),
        ...
        self.has_gt = has_gt
        self.cfg = cfg
        self.filter_dataset_map(cfg)
        


    def filter_dataset_map(self, cfg):
        ...
        self.target_transform.label_map = COCO_INTER_LABEL_MAP if self.cfg.dataset.dataset_map == 'coco-inter' else COCO_YTVIS_LABEL_MAP
    ...
    def pull_item(self, index):
        ...
        if (self.cfg.joint_dataset is not None and self.cfg.joint_dataset.dataset_map is not None) \
                or self.cfg.dataset.dataset_map is not None:
