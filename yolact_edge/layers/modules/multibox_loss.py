...
from yolact_edge.data import mask_type, activation_func
...
class MultiBoxLoss(nn.Module):
    ...
    def __init__(self, num_classes, pos_threshold, neg_threshold, negpos_ratio, cfg):
    ...
    def forward(self, predictions, targets, masks, num_crowds):
        ...
        for idx in range(batch_size):
            ...
            match(self.pos_threshold, self.neg_threshold,
                  ...
                  loc_t, conf_t, idx_t, idx, loc_data[idx], cfg=self.cfg)
